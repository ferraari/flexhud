...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    createRoundedRectangle('bgHealth', circleScale - 10 , circleScale - 10, 10)
    createRoundedRectangle('bgOfAll', circleScale + 210,  circleScale, 15)
    createRoundedRectangle('bgArmor', circleScale - 10 , circleScale - 10, 10)
    createRoundedRectangle('bgFeed', circleScale - 10 , circleScale - 10, 10)
    createRoundedRectangle('bgThirst', circleScale - 10 , circleScale - 10, 10)
    createRoundedRectangle('bgGas', circleScale + 25 , circleScale -15, 10)

    createRoundedRectangle('health', circleScale - 10 , circleScale - 10, 5)
    createRoundedRectangle('armor', circleScale - 10 , circleScale - 10, 5)
    createRoundedRectangle('feed', circleScale - 10 , circleScale - 10, 5)
    createRoundedRectangle('thirst', circleScale - 10 , circleScale - 10, 5)
...
addEventHandler("onClientRender", root, function()
    ...
    drawItem('bgHealth', rightScreen - 220, bottomScreen, tocolor(28,28,28,170))
    drawItem('health', rightScreen - 220, bottomScreen, tocolor(0, 114, 246,170))
    ...
    drawItem('bgArmor', rightScreen - 170, bottomScreen, tocolor(28,28,28,170))
    drawItem('armor', rightScreen - 170, bottomScreen, tocolor(0, 114, 246,170))
    ...
    drawItem('bgFeed', rightScreen - 120, bottomScreen, tocolor(28,28,28,170))
    drawItem('feed', rightScreen - 120, bottomScreen, tocolor(0, 114, 246,170))
    ...
    drawItem('bgThirst', rightScreen - 70, bottomScreen, tocolor(28,28,28,170))
    drawItem('thirst', rightScreen - 70, bottomScreen, tocolor(0, 114, 246,170))
